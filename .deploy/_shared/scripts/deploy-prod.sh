...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  Yakyn Bot - Production Deployment${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${GREEN}========================================${NC}"
    echo ""
    echo -e "Container: ${BLUE}yakyn-bot-prod${NC}"
    echo -e "Port: ${BLUE}http://localhost:10302${NC}"
    echo ""
    echo -e "Commands:"
    echo -e "  ${YELLOW}docker logs -f yakyn-bot-prod${NC} - View logs"
